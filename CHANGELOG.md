...
- Fixed Tauri command parameter naming in TauriPromptService.ts:
  - Changed prompt_id → promptId (TypeScript to Rust parameter conversion)
  - Changed auto_paste → autoPaste (TypeScript to Rust parameter conversion)
  - Tauri v2 expects camelCase from JavaScript, converts to snake_case for Rust
